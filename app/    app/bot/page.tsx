    ...
    if(msg.includes('lost') || msg.includes('find')) {
      ...
      if(matches.length > 0) {
        return `I found ${matches.length} possible matches! 🔍 \n\n` +
          ...
          `\n\nWant me to open the full list?`
      } else {
        return `Sorry, I couldn't find any matches for "${msg}". Try posting a report and I'll notify you if something matches!`
      }
    }

    if(msg.includes('hello') || msg.includes('hi')) {
      return "Hello! 👋 How can I help you today? You can say 'I lost my wallet' or 'I found keys'"
    }

    return "I can help you search lost/found items! Try: 'I lost my ID card' or 'Someone found a phone'"
  }
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-800/60 backdrop-blur-lg rounded-2xl shadow-2xl border-purple-500/30 h-[80vh] flex flex-col">
          <div className="p-4 border-b border-gray-700">
            ...
            <p className="text-gray-400 text-sm">I can search all lost & found reports for you</p>
          </div>
          ...
          <div className="p-4 border-t border-gray-700 flex gap-2">
            <input
              ...
              placeholder="Ask me: I lost my wallet..."
              className="flex-1 p-3 rounded-lg bg-gray-700 text-white border-gray-600"
            />
            <button onClick={handleSend} className="bg-purple-500 px-6 py-3 rounded-lg text-white font-semibold hover:bg-purple-600">
              Send
            </button>
          </div>
        </div>
